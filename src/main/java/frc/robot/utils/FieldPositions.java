...
public final class FieldPositions {
    ...
    private static final StructSubscriber<Pose2d> bluePassLeft2dSub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "BluePassLeft", Pose2d.struct)
            .subscribe(Constants.FieldConstants.bluePassLeftPose);

    private static final StructSubscriber<Pose2d> bluePassRight2dSub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "BluePassRight", Pose2d.struct)
            .subscribe(Constants.FieldConstants.bluePassRightPose);

    private static final StructSubscriber<Pose2d> redPassLeft2dSub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "RedPassLeft", Pose2d.struct)
            .subscribe(Constants.FieldConstants.redPassLeftPose);

    private static final StructSubscriber<Pose2d> redPassRight2dSub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "RedPassRight", Pose2d.struct)
            .subscribe(Constants.FieldConstants.redPassRightPose);
    ...
    private static final StructPublisher<Pose2d> bluePassLeft2dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "BluePassLeft", Pose2d.struct).publish();

    private static final StructPublisher<Pose2d> bluePassRight2dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "BluePassRight", Pose2d.struct).publish();

    private static final StructPublisher<Pose2d> redPassLeft2dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "RedPassLeft", Pose2d.struct).publish();

    private static final StructPublisher<Pose2d> redPassRight2dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT2D + "RedPassRight", Pose2d.struct).publish();
    ...
    private static final StructPublisher<Pose3d> bluePassLeft3dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT3D + "BluePassLeft", Pose3d.struct).publish();

    private static final StructPublisher<Pose3d> bluePassRight3dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT3D + "BluePassRight", Pose3d.struct).publish();

    private static final StructPublisher<Pose3d> redPassLeft3dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT3D + "RedPassLeft", Pose3d.struct).publish();

    private static final StructPublisher<Pose3d> redPassRight3dPub = NetworkTableInstance.getDefault()
            .getStructTopic(ROOT3D + "RedPassRight", Pose3d.struct).publish();
    ...
    static {
        ...
        bluePassLeft2dPub.set(Constants.FieldConstants.bluePassLeftPose);
        bluePassRight2dPub.set(Constants.FieldConstants.bluePassRightPose);
        redPassLeft2dPub.set(Constants.FieldConstants.redPassLeftPose);
        redPassRight2dPub.set(Constants.FieldConstants.redPassRightPose);
        ...
        bluePassLeft3dPub.set(new Pose3d(Constants.FieldConstants.bluePassLeftPose));
        bluePassRight3dPub.set(new Pose3d(Constants.FieldConstants.bluePassRightPose));
        redPassLeft3dPub.set(new Pose3d(Constants.FieldConstants.redPassLeftPose));
        redPassRight3dPub.set(new Pose3d(Constants.FieldConstants.redPassRightPose));
    }
    ...
    public static Pose2d getBluePassLeftPose() {
        return bluePassLeft2dSub.get();
    }

    public static Pose2d getBluePassRightPose() {
        return bluePassRight2dSub.get();
    }

    public static Pose2d getRedPassLeftPose() {
        return redPassLeft2dSub.get();
    }

    public static Pose2d getRedPassRightPose() {
        return redPassRight2dSub.get();
    }
}